...
namespace Sbrpg::Runtime
{
    namespace
    {
        char const* CapabilityList = "START,STATUS,SET,SET_CONFIG,STOP,MATERIAL_CATALOG,MATERIAL_SOURCES,START_MATERIAL,START_FISHING,MATERIAL_STATUS,DANGER_SCREENING,ADAPTIVE_ORDERING,NODE_CHEST_LOOT,FORCE_STOP";
        std::array<char const*, 14> const CapabilityNames = {{
            "START", "STATUS", "SET", "SET_CONFIG", "STOP", "MATERIAL_CATALOG",
            "MATERIAL_SOURCES", "START_MATERIAL", "START_FISHING", "MATERIAL_STATUS",
            "DANGER_SCREENING", "ADAPTIVE_ORDERING", "NODE_CHEST_LOOT", "FORCE_STOP"
        }};
    }
